...
class NPC(pg.sprite.Sprite):
    def __init__(self, x, y, npc_type, difficulty):
        ...
        self.sound_system.load_enemy_npc_sounds()
        self.size = BLOCK_SIZE
        self.rect = pg.Rect(x, y, BLOCK_SIZE, BLOCK_SIZE)
    ...
    def set_difficulty(self, level):
        if not level: return
        self.skills.set_skill_level("strenght", level)
        self.skills.set_skill_level("accuracy", level)
